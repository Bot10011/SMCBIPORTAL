...
export default function CourseManagement() {
  ...
  const filteredCourses = courses.filter(course => {
    ...
    const matchesFilter = filterUnits === 'all' || course.units.toString() === filterUnits;
        ...
        >
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            <div>
              ...
              <p className="text-gray-600 text-lg">Manage and organize your academic courses efficiently</p>
            </div>
                  ...
                  <tbody className="divide-y divide-gray-100">
                    {filteredCourses.map((course) => (
                      <tr key={course.id} className="hover:bg-gray-50 transition-colors duration-200">
                        ...
                        <td className="px-6 py-4 text-gray-700 max-w-xs truncate">{course.description}</td>
                        <td className="px-6 py-4">
